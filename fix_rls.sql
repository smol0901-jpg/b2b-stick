-- ============================================================
-- ФИНАЛЬНЫЙ ФИКС RLS — копируй именно этот блок
-- ============================================================

-- 1. Helper-функции (SECURITY DEFINER — обходят RLS, рекурсии не будет)
...
-- 2. ДРОПАЕМ ВСЕ СТАРЫЕ ПОЛИТИКИ (без ошибок, если их нет)
-- profiles
...
-- 4. ДИАГНОСТИКА — должно вернуть ВСЕ политики без рекурсии
